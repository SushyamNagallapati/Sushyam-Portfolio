...
const Index = () => {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="relative flex-1 flex flex-col justify-center pt-20 pb-16 sm:pt-24 sm:pb-20 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="flex flex-col lg:flex-row lg:items-center gap-10 sm:gap-12 lg:gap-16 xl:gap-24">
            {/* Text Content */}
            ...
            {/* Profile Photo */}
            <div className="flex justify-center lg:justify-end flex-shrink-0 order-1 lg:order-2">
              <ProfileCard />
            </div>
          </div>

          {/* Tech Stack — centered, full-width strip */}
          <div className="mt-12 sm:mt-16 lg:mt-20 flex flex-col items-center text-center">
