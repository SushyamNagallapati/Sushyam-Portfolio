...
const Header = () => {
  ...
  const navItems = [
    ...
    { label: "RESUME", href: "{ label: "RESUME", href: "https://drive.google.com/file/d/1_vDMkN7Duow5DrriBFWrxN1F4xY-Ujvx/view?usp=sharing", active: false, isExternal: true },", active: false, isExternal: true },
