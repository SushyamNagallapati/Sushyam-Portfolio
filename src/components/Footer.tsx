...
const Footer = () => {
  return (
    <footer className="fixed bottom-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-xl border-t-2 border-border transition-all duration-300">
          ...
          <div className="flex flex-wrap items-center justify-center gap-5 sm:gap-10 text-xs sm:text-sm">
            ...
            <div className="text-center">
              ...
              <a
                ...
                className="text-muted-foreground hover:text-primary transition-colors duration-300 text-[11px] sm:text-sm"
              >
