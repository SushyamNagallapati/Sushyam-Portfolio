...
const TechPill = ({ tech }: { tech: Tech }) => (
  <div className="inline-flex shrink-0 items-center gap-2 whitespace-nowrap rounded-full border border-border/60 bg-card px-3 py-1.5 text-xs text-muted-foreground select-none">
    {tech.icon && (
      <img
        src={tech.icon}
        alt=""
